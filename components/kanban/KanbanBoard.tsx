...
const columnColors: Record<DefectStatus, { bg: string; text: string; border: string; indicator: string }> = {
  TODO: { bg: 'bg-amber-50', text: 'text-amber-800', border: 'border-amber-200', indicator: 'bg-amber-500' },
  IN_PROGRESS: { bg: 'bg-blue-50', text: 'text-blue-800', border: 'border-blue-200', indicator: 'bg-blue-500' },
  DONE: { bg: 'bg-emerald-50', text: 'text-emerald-800', border: 'border-emerald-200', indicator: 'bg-emerald-500' },
};
